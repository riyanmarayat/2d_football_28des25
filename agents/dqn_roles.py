...
class DQNGoalkeeperAgent(DQNTacticsAgent):
    def __init__(self, team: str, player_index: int, seed: Optional[int] = 0):
        super().__init__(team, player_index, seed=seed, max_move_speed=5.0, sprint_multiplier=1.05)


class DQNCenterBackAgent(DQNTacticsAgent):
    def __init__(self, team: str, player_index: int, seed: Optional[int] = 0):
        super().__init__(team, player_index, seed=seed, max_move_speed=5.4, sprint_multiplier=1.1)


class DQNRightFullbackAgent(DQNTacticsAgent):
    def __init__(self, team: str, player_index: int, seed: Optional[int] = 0):
        super().__init__(team, player_index, seed=seed, max_move_speed=5.8, sprint_multiplier=1.2)
...
class DQNCentralMidfielderAgent(DQNTacticsAgent):
    def __init__(self, team: str, player_index: int, seed: Optional[int] = 0):
        super().__init__(team, player_index, seed=seed, max_move_speed=6.0, sprint_multiplier=1.25)


class DQNRightMidfielderAgent(DQNTacticsAgent):
    def __init__(self, team: str, player_index: int, seed: Optional[int] = 0):
        super().__init__(team, player_index, seed=seed, max_move_speed=6.1, sprint_multiplier=1.25)
...
class DQNRightWingerAgent(DQNTacticsAgent):
    def __init__(self, team: str, player_index: int, seed: Optional[int] = 0):
        super().__init__(team, player_index, seed=seed, max_move_speed=6.4, sprint_multiplier=1.3)
